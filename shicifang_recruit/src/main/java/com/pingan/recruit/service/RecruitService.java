package com.pingan.recruit.service;

import com.pingan.recruit.dao.RecruitDao;
...
public class RecruitService {
	...
	/**
	 * 状态为2并以创建日期降序排序，查询前4条记录的职位
	 * @return
	 * select * from tb_recuit where state = 2 order by 日期 desc limit 0,4
	 */
	public List<Recruit> queryByStatus() {
	 ...
	 * @return
	 */
	public List<Recruit> queryByState() {
