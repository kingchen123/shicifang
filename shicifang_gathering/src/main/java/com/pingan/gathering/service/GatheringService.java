package com.pingan.gathering.service;

import com.pingan.gathering.dao.GatheringDao;
...
public class GatheringService {
     ...
     * @return
     */
    @Cacheable(value = "gathering_", key = "#id")
     ...
     * @param gathering
     */
    @CacheEvict(value = "gathering_",key = "#gathering.id")
     ...
     * @param id
     */
    @CacheEvict(value = "gathering_",key = "#id")
